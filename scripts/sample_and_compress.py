...
DEFAULT_DATASETS = [
    ...
    "NousResearch/clawg-megascience-sft1",
    "NousResearch/clawg-Thinking-GLM-4.7-SFT2",
    "NousResearch/clawg-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-clawg"
]
