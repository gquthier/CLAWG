...
echo -e "    ${CYAN}clawg second-brain autoscan${NC} — ${PURPLE}Auto-configure vault via LLM scan${NC}"
echo -e "    ${CYAN}clawg second-brain status${NC}   — Check vault connection"
echo -e "    ${CYAN}clawg config show${NC}           — Edit your configuration"
echo -e "    ${CYAN}clawg gateway install${NC}       — Install messaging service"
echo -e "    ${CYAN}clawg skills list${NC}           — Browse installed skills"
