...
Usage:
    clawg pairing list              # Show all pending + approved users
    clawg pairing approve <platform> <code>  # Approve a pairing code
    clawg pairing revoke <platform> <user_id> # Revoke user access
    clawg pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle clawg pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: clawg pairing {list|approve|revoke|clear-pending}")
        print("Run 'clawg pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(f"  Run 'clawg pairing list' to see pending codes.\n")
