"""Slash command definitions and autocomplete for the clawg CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("paste", "Check clipboard for an image and attach it", "Info",
               cli_only=True),
    CommandDef("update", "Update CLAWG to the latest version", "Info",
               gateway_only=True),
...
def slack_subcommand_map() -> dict[str, str]:
    """Return subcommand -> /command mapping for Slack /clawg handler.

    Maps both canonical names and aliases so /clawg bg do stuff works
    the same as /clawg background do stuff.
    """
