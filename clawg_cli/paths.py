...
| `Large Memory/` | MEMORY.md (persistent memory) | Managed by `memory` tool. Updated automatically |
...
""",
        ...
        root / "skills" / "INDEX.md": """# Skills Registry

> **For agents**: Read this file BEFORE executing any task. If a skill matches, load it with `skill_view <category>/<name>` instead of reinventing.

Skills are organized by category. Use the navigation table to find what you need.

## Quick Navigation

| Category | When to use |
|----------|-------------|
| [Development](#development) | Planning, TDD, debugging, code review, delegation |
| [GitHub](#github) | Repos, issues, PRs, CI, code review |
| [Productivity](#productivity) | Google Workspace, Notion, Linear, PDF, OCR, PPTX |
| [Research](#research) | Web search, academic papers, feed monitoring |
| [Communication](#communication) | Email, iMessage, Apple Notes/Reminders |
| [Content](#content) | YouTube transcripts, diagrams, ASCII art |
| [Integration](#integration) | MCP servers, vault dashboards |

## How to Use a Skill

1. Find the skill in a category table below
...
2. Use this frontmatter:
   ...
   ---
   ```
3. Add one row to the matching category table below
4. If new category: add a `##` section + a row in Quick Navigation

**Rules**: One SKILL.md per folder. No overlap with native tools (check `environment.md`). Skills are shared across ALL agents.

---

*This file is auto-generated by `clawg second-brain init`. Add your skills below.*
""",
