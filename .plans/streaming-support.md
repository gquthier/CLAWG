# Streaming LLM Response Support for CLAWG
...
```
CLAWG_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CLAWG_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `clawg_cli/config.py` | 1 | +streaming config defaults |
