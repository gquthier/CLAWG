...
version: 1.1.0
author: CLAWG (adapted from obra/superpowers)
license: MIT
metadata:
  clawg:
...
> **For clawg:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use clawg tools to understand the project:
