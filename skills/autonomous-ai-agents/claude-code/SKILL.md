...
metadata:
  clawg:
    ...
    related_skills: [codex, clawg]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the clawg terminal. Claude Code is Anthropic's autonomous coding agent CLI.
