...
metadata:
  clawg:
    ...
    related_skills: [claude-code, clawg]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the clawg terminal. Codex is OpenAI's autonomous coding agent CLI.
