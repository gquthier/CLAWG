...
- [jasper-configguard](https://clawskills.sh/skills/emberdesire-jasper-configguard) - Safe config changes for clawg with automatic.
...
- [security-checker](https://clawskills.sh/skills/johstracke-security-checker) - Security scanner for Python skills before publishing to ClawgHub.
