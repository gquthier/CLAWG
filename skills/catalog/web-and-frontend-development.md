...
- [bring-rezepte](https://clawskills.sh/skills/dolverin-bring-rezepte) - Use when running the CLAWG/ClawHub Bring! skill to search recipes on the web, parse recipe URLs for ingredients.
