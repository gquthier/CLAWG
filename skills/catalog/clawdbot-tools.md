...
- [adhd-assistant](https://clawskills.sh/skills/thinktankmachine-adhd-assistant) - ADHD-friendly life management assistant for clawg.
- [adhd-ssistant](https://clawskills.sh/skills/thinktankmachine-adhd-ssistant) - ADHD-friendly life management assistant for clawg.
...
- [agent-builder](https://clawskills.sh/skills/plgonzalezrx8-agent-builder) - Build high-performing clawg agents end-to-end.
...
- [captchas-clawg](https://clawskills.sh/skills/captchasco-captchas-clawg) - clawg integration guidance for CAPTCHAS Agent API.
...
- [provider-sync](https://clawskills.sh/skills/c-joey-provider-sync) - Sync provider models into clawg config.
- [telegram-footer-patch](https://clawskills.sh/skills/c-joey-telegram-footer-patch) - Patch Telegram replies with clawg footer.
