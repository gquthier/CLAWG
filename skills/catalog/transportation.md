...
- [free-ride](https://clawskills.sh/skills/shaivpidadi-free-ride) - Manages free AI models from OpenRouter for CLAWG.
- [freeride](https://clawskills.sh/skills/shaivpidadi-freeride) - Manages free AI models from OpenRouter for CLAWG.
- [freeride-ai](https://clawskills.sh/skills/shaivpidadi-freeride-ai) - Manages free AI models from OpenRouter for CLAWG.
...
- [proxybase-clawg-skill](https://clawskills.sh/skills/proxybase-user-proxybase-clawg-skill) - No one can block your claw after this. Automatically provisions socks5 proxies.
