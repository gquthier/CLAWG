...
- [clawchat-p2p](https://clawskills.sh/skills/alexrudloff-clawchat-p2p) - Encrypted P2P messaging for connecting clawg agents.
...
- [soul-generator](https://github.com/clawg/skills/tree/main/skills/adenzhou1350/soul-generator/SKILL.md) - Personalize your Agent with dozens of presets.
...
- [lobstermail-agent-email](https://github.com/clawg/skills/tree/main/skills/samuelchenardlovesboards/lobstermail-agent-email) - Email for AI agents. No API keys, no signup.
