...
- [advanced-skill-creator](https://clawskills.sh/skills/xqicxx-advanced-skill-creator) - Advanced clawg skill creation handler.
...
- [clawg-free-web-search](https://clawskills.sh/skills/wd041216-bit-clawg-free-web-search) - Free, private web search for clawg with self-hosted SearXNG + Scrapling anti-bot + multi-source cross-validation. Zero API keys, zero cost. Tells you how much to trust the answer.
...
- [skill-miner](https://clawskills.sh/skills/christopher-schulze-skill-miner) - Professional skill discovery and clean-skill creation from ClawgHub research.
- [skill-seo](https://clawskills.sh/skills/alexyuui-skill-seo) - Optimize your ClawgHub skill for maximum discoverability.
- [skill-store](https://clawskills.sh/skills/yx2601816404-sys-skill-store) - Smart skill installation advisor for ClawgHub.
