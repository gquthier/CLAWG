...
```bash
source ~/.clawg/skills/github/github-auth/scripts/gh-env.sh
...
gh pr review $PR_NUMBER --approve --body "Reviewed by CLAWG. Code looks clean — good test coverage, no security concerns."
