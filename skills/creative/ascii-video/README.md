...
Built for [CLAWG](https://github.com/NousResearch/clawg). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/clawg/skills/creative/ascii-video`](https://github.com/NousResearch/clawg/tree/main/skills/creative/ascii-video) via PR.
