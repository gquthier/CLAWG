...
Built for [CLAWG](https://github.com/gquthier/CLAWG). Usable in any coding agent. Canonical source lives here; synced to [`gquthier/CLAWG/skills/creative/ascii-video`](https://github.com/gquthier/CLAWG/tree/main/skills/creative/ascii-video) via PR.
