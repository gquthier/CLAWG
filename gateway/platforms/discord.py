...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your clawg session")
        ...
        @tree.command(name="status", description="Show clawg session status")
        ...
        @tree.command(name="stop", description="Stop the running CLAWG")
        ...
        @tree.command(name="update", description="Update CLAWG to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="thread", description="Create a new thread and start a clawg session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to clawg in the thread",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new clawg session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by clawg: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "clawg"
        if len(content) > 80:
    ...
    def _thread_state_path() -> Path:
        ...
        return get_clawg_home() / "discord_threads.json"
