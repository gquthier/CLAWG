"""
Email platform adapter for the clawg gateway.

Allows users to interact with clawg by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        msg_id = f"<clawg-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
