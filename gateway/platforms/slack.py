...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            @self._app.command("/clawg")
            async def handle_clawg_command(ack, command):
                await ack()
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from clawg_cli.commands import slack_subcommand_map
