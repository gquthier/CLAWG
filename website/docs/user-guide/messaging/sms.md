...
sidebar_position: 8
title: "SMS (Twilio)"
description: "Set up CLAWG as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

clawg connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back — same conversational experience as Telegram or Discord, but over standard text messages.
...
If you're running clawg locally, use a tunnel to expose the webhook:
...
Text your Twilio number — clawg will respond via SMS.
...
3. Check clawg gateway logs for Twilio API errors
