...
clawg tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. clawg resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`clawg-cli`, `clawg-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `clawg-acp`
