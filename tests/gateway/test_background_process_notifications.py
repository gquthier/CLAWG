...
def _build_runner(monkeypatch, tmp_path, mode: str) -> GatewayRunner:
    ...
    monkeypatch.setattr(gateway_run, "_clawg_home", tmp_path)
...
class TestLoadBackgroundNotificationsMode:
    ...
    def test_defaults_to_all(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(gw, "_clawg_home", tmp_path)
        monkeypatch.delenv("CLAWG_BACKGROUND_NOTIFICATIONS", raising=False)
    ...
    def test_env_var_overrides_config(self, monkeypatch, tmp_path):
        ...
        import gateway.run as gw
        monkeypatch.setattr(gw, "_clawg_home", tmp_path)
        monkeypatch.setenv("CLAWG_BACKGROUND_NOTIFICATIONS", "off")
