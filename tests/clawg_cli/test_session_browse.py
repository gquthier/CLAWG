"""Tests for the interactive session browser (`clawg sessions browse`).
...
from clawg_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """clawg sessions browse should be parseable."""
        from clawg_cli.main import main as _main_entry
