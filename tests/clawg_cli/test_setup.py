...
from clawg_cli.auth import _update_config_for_provider, get_active_provider
from clawg_cli.config import load_config, save_config
from clawg_cli.setup import setup_model_provider
...
def test_nous_oauth_setup_keeps_current_model_when_syncing_disk_provider(
    ...
    monkeypatch.setattr("clawg_cli.auth._login_nous", _fake_login_nous)
    monkeypatch.setattr(
        "clawg_cli.auth.resolve_nous_runtime_credentials",
        lambda *args, **kwargs: {
    ...
    monkeypatch.setattr(
        "clawg_cli.auth.fetch_nous_models",
