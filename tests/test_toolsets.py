...
class TestToolsetConsistency:
    ...
    def test_clawg_platforms_share_core_tools(self):
        """All clawg-* platform toolsets should have the same tools."""
        platforms = ["clawg-cli", "clawg-telegram", "clawg-discord", "clawg-whatsapp", "clawg-slack", "clawg-signal", "clawg-homeassistant"]
