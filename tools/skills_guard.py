...
Trust levels:
  - builtin:   Ships with clawg. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.clawg/\.env|\~/\.clawg/\.env',
     "clawg_env_access", "critical", "exfiltration",
     "directly references clawg secrets file"),
    ...
    (r'\.clawg/config\.yaml|\.clawg/SOUL\.md',
     "clawg_config_mod", "critical", "persistence",
     "references clawg configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.clawg/config.yaml."""
    try:
