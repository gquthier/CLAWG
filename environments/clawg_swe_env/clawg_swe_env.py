"""
ClawgSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser clawg
    run-api
    python environments/clawg_swe_env.py serve \\
...
class ClawgSweEnv(ClawgAgentBaseEnv):
    ...
    name = "clawg-swe"
    env_config_cls = ClawgSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ClawgSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = ClawgSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepClawg-3-Llama-3-3B-Preview",
            tool_call_parser="clawg",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="clawg-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepClawg-3-Llama-3-3B-Preview",
