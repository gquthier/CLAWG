"""
Monkey patches for making clawg tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by clawg_base_env.py).
