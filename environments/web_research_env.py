...
Inspired by: GroceryMind — production CLAWG doing live web research
             across German grocery stores (firecrawl + clawg)
"""
...
class WebResearchEnvConfig(ClawgAgentEnvConfig):
...
class WebResearchEnv(ClawgAgentBaseEnv):
    """
