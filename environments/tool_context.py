...
ALL clawg tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all clawg tools for a specific rollout.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("CLAWG_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("CLAWG_QUIET", None)
            else:
                os.environ["CLAWG_QUIET"] = _prev_quiet
